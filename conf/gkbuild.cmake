...
if(QMETIS_PORTABLE_X86_64 AND CMAKE_C_COMPILER_ID MATCHES "^(GNU|Clang|AppleClang)$")
  set(GK_COPTIONS "${GK_COPTIONS} -march=x86-64 -mtune=generic")
elseif(CMAKE_COMPILER_IS_GNUCC AND VALGRIND)
  set(GK_COPTIONS "${GK_COPTIONS} -march=x86-64 -mtune=generic")
...
if(${CMAKE_C_COMPILER_ID} STREQUAL "Intel" AND NOT QMETIS_PORTABLE_X86_64)
